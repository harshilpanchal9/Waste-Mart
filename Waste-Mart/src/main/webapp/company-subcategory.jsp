		...
		<div class="wrapper">
			<div class="w3l-features-photo-7_top">
					...
					<div class="color-quality-right">
					 ...
					 <br>
					 <div class="buttons">
						<a href="company-category.jsp" style="margin-left:270px;background:#228B22;font-size: 16px;color: #ffffff;border:none;" class="actionbg1">Back to Category</a>
...
<section class="w3l-products-17">
	<div class="products17">
		...
		%>
				...
				<form action="CompanyRegistrationController" method="post" enctype="multipart/form-data">
					...
					<input type="submit" name="btn" class="addtocart_btn" value="AddtoCart"><a  class="addbtn"></a>
					</form>
				</div>
