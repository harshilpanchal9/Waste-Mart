    ...
    <div class="covers-9">
        <div class="csslider infinity" id="slider1">
            ...
            <ul class="banner_slide_bg">
                ...
                <li style="background:url('slider_assets/slider1.jpg') no-repeat center; background-size: 100% 100%;">
                    <div class="wrapper">
                        <div class="cover-top-center-9">
                             <div class="w3ls_cover_txt-9">
                                <h6 class="tag-cover-9"></h6>
                ...
                <li style="background:url('slider_assets/s2.jpg') no-repeat center; background-size: 100% 100%;">
                    <div class="wrapper">
                        <div class="cover-top-center-9">
                            <div class="w3ls_cover_txt-9">
                                <h6 class="tag-cover-9"></h6>
...
<section class="_w3l-cover-3">
    <div class="cover top-bottom" style="background:url('slider_assets/slider1.jpg') no-repeat center; background-size: 100% 100%;">
