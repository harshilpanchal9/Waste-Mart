		...
		<div class="main-wrapper">
			...
			<article class="content item-editor-page">
                    <div class="title-block">
                        <h3 class="title"> View Zoner details <span class="sparkline bar" data-type="bar"></span>
                                ...
                                <div class="col-sm-12" style="display:flex;justify-content: center;">
                                    <div class="images-container">
                                        <div class="image-container" style="border-radius: 50%;">                                            
                                            <div class="image" style="background-image:url('../zoner-images/<%=rs.getString(11)%>')"></div>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Zoner ID</label>
                                <input type="text" class="form-control underlined" value="<%=rs.getInt(1) %>" style="pointer-events: none;">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Zoner name</label>
                                <input type="text" class="form-control underlined" value="<%=rs.getString(2) %> <%=rs.getString(3) %>" style="pointer-events: none;">
                            </div>                            
                            <div class="form-group">
