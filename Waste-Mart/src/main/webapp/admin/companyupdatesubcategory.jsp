...
<body>
			...
			<article class="content item-editor-page">
                    <div class="title-block">
                        ...
                        <a href="companyviewsubcategory.jsp"><i class="fa fa-times" style="position: absolute;right: 3%;"></i></a>
                        </h3>                  
                    </div>
                    <%  int subcatid = Integer.parseInt(request.getParameter("subcatid"));                    	                    
	                    SubCategoryModel model = new CategoryDao().companyGetRecordItem(subcatid);	
	        			if(model==null)
	        			{
	        				out.println("<script type=\"text/javascript\">");
	        				out.println("alert('Cannot edit company item.')");
	        				out.println("window.location.href='companyviewsubcategory.jsp';");
	        				out.println("</script>");
	        			}
	        			else
	        			{
                    %>
                    <form method="post" action="../CategoryController" name="item" enctype="multipart/form-data">                    
                        <div class="card card-block">
                            ...
                            <div class="form-group row has-error">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="itemname" name="itemname" class="form-control boxed" placeholder="" value="<%=model.getItemname()%>" required onkeyup="nameValidation()">
                            ...
                            <div class="form-group row has-error">
                                ...
                                <div class="col-sm-10" >                                	                                                               
                                   <div class="input-group" style="margin-bottom:0px;">                            
                                		...
                                		<input type="text" id="itemprice" name="itemprice" class="form-control" placeholder=" per KG" value="<%=model.getItemprice()%>" required onkeyup="numberValidation()">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10 col-sm-offset-2">
                                    ...
                                    <button type="submit" name="btn" value="companyUpdateItem" class="btn btn-primary" onclick="return submitValidation()"> Update item </button>
                                </div>
                            </div>
                        </div>
                    </form>
	  	 ...
	  	 element3.classList.add("open");
	 		...
	 		function submitValidation() {    		        
	 			var itemname = document.getElementById("itemname").value;
  	 			...
  	 			if (itemname.length == 0 || price.length == 0 || (catimage.value == '' && oldimage.value == '')){    
		        		//Itemname
