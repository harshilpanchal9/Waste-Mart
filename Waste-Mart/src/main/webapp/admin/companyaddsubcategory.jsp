...
<head>
        ...
        <title> Admin | Add Company Items </title>
...
<div class="main-wrapper">
			...
			<article class="content item-editor-page">
                    <div class="title-block">
                        <h3 class="title"> Add Company Item <span class="sparkline bar" data-type="bar"></span>
                        </h3>
                    </div>
                        ...
                        <div class="card card-block">
                                    ...
                                    <div class="images-container">                                                                                
                                        ...
                                        <a href="#" class="add-image">                                        
                                            <div class="image-container new" style="margin-bottom:0px;">                                            	
                                                <div class="image" onclick="myFile()" id="imginput">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10 col-sm-offset-2">
                                    <button type="submit" name="btn" value="companyAddItem" class="btn btn-primary"> Add Item </button>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        <script>
        	...
        	var element = document.getElementById("item");
	  	 	...
	  	 	var element4 = document.getElementById("addsubcategory");
	  	 	element4.classList.add("open");
	  	 	var element3 = document.getElementById("companyaddsubcategory");
  	 		...
  	 		function submitValidation() {    
		        ...
		        if (document.getElementById("dropdown").value == "Select Category" || itemname.length == 0 || price.length == 0 || catimage.value == '') {    
		        		//Category Dropdown
