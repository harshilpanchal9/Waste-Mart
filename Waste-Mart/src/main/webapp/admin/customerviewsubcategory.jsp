                ...
                <article class="content items-list-page">
                    <div class="title-search-block">
                        <div class="title-block">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="title"> Consumer Items 
                                    	<a href="customeraddsubcategory.jsp" class="btn btn-primary btn-sm rounded-s" style="height: 33px;padding-top: 7px;margin-right: 10px;"> Add New Item</a>                                    	
                            ...
                            <form class="form-inline" action="../SearchController" method="post">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button type="submit" name="btn" value="searchCustomerSubCategory" class="btn btn-secondary rounded-s" style="padding-bottom: 7.5px;" type="button">
                        ...
                        <ul class="item-list striped">
                            <li class="item item-list-header">
                                <div class="item-row">
                                    ...
                                    <div class="item-col item-col-header item-col-author" style="padding-left: 6px;flex-grow:2.6">
                                        <div class="no-overflow" style="text-align: center;">
                                            <span>Category</span>
                                        </div>
                                    </div>
                                    <div class="item-col item-col-header item-col-title" style="flex-grow:5.3;padding-left: 16px;">
                                        <div style="text-align: center;">
                                            <span>Item Name</span>
                                        </div>
                                    </div>
                                    <div class="item-col item-col-header item-col-sales" style="flex-grow: 2.2;padding-right: 0px;padding-left:22px">
                                        <div style="text-align: center;padding-left: 10px;">
                                            <span>Stock (per <i>KG</i>)</span>
                                        </div>
                                    </div>
                            ...
                            <li class="item">
                                <div class="item-row">                                	                                        
                                    ...
                                    <div class="item-col item-col-stats" style="text-align: center;flex-grow: 2.2;padding-right: 5px;">
                                        <div class="item-heading">Stock(per KG.)</div>
                                        <div class="no-overflow"> <%= rs.getString(6) %> </div>
                                    </div> 
                                        ...
                                        <div class="item-actions-dropdown">
                                            ...
                                            <div class="item-actions-block">
                                                <ul class="item-actions-list">
                                                    ...
                                                    <li>                                                        
                                                        <a class="edit" href="customerupdatesubcategory.jsp?subcatid=<%=rs.getInt(1)%>">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                            	<form action="../CategoryController">                            		
                                	...
                                	<button type="submit" name="action" value="customerdeletesubitem" class="btn btn-primary">Yes</button>                                	
                                </form>
