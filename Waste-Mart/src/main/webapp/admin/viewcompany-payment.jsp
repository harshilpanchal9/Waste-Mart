		...
		<div class="main-wrapper">
			...
			<article class="content item-editor-page">
                    <div class="title-block">
                        ...
                        <a href="payment.jsp"><i class="fa fa-times" style="position: absolute;right: 3%;"></i></a>
                        </h3>                  
                    </div>    
                    <%  int requestid = Integer.parseInt(request.getParameter("requestid")); 
                        ...
                        <div class="card card-block" style="width:68%;margin-left:auto;margin-right:auto;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control underlined" value="<%=rs2.getString(2) %>" style="pointer-events: none;">
                            </div>  
                            <%
                            	}
                            %>    
