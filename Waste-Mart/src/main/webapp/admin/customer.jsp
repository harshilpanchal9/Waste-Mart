            	...
            	<article class="content items-list-page">
                    ...
                    <div class="card items">
                        <ul class="item-list striped">
                            ...
                            <li class="item" id="userdata"></li>	<!-- Print the Customer Data -->                             
                        </ul>
                    </div>   
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Do you want to deactive this user profile ?</p>
                            </div>
                            <div class="modal-footer">
                            	<form action="../UserCustomerController">                            		
                            			<span id="checkboxcatid"></span>
                                		<button type="submit" name="btn" value="deactivecustomer" class="btn btn-primary">Yes</button>                                	     
                                </form>
        ...
        <div class="ref" id="ref">
			...
			<!------------------------->
	   	    ...
	   	    window.onload = function(){
	   	    	...
	   	    	if(id==null){
	   	    		...
	   	    		if(all!="null"){	   	    			
	   	    			radioData();	   	    			
	   	    			if(id=="Active"){		   	    				
	   	    				window.history.pushState('', '', url.replace('/customer.jsp?status=Active&all=All', '/customer.jsp'));   	    			
		   	    		}
		   	    		else if(id=="Deactive"){		   	    			
		   	    			window.history.pushState('', '', url.replace('/customer.jsp?status=Deactive&all=All', '/customer.jsp'));		   	    			
		   	    		}
	   	    		}else
	   	    		{	   	    			
	   	    			radioData(id);
	   	    			if(id=="Active"){	   	    			
		   	    			window.history.pushState('', '', url.replace('/customer.jsp?status=Active&all=null', '/customer.jsp'));		   	    			
		   	    		}
		   	    		else if(id=="Deactive"){		   	    			
		   	    			window.history.pushState('', '', url.replace('/customer.jsp?status=Deactive&all=null', '/customer.jsp'));		   	    			
		   	    		}	
	   	    		}	   	    				   	    	
	   	    	}		   	    	
	   	    }
		  	 ...
		  	 function SelectAll(cb){
		  		...
		  		var singlecb = document.getElementsByName('cust_id');
