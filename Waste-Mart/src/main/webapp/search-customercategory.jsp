...
<%
	...
	String subcategory="select * from customer_subcategory where catid=?";
			            ...
			            out.print("<h1 style='text-align:center;'>"+rs.getString(2)+"</h1>");
			          		out.print("<div class='middle-section'>");
			          			...
			          			while(rs2.next())
			          			{
					          		...
					          		out.print("<p style='text-align:center;'>&#8377;"+rs2.getString(4)+"/kg</p>");
					          		out.print("</div></div>");
	...
	{
		PreparedStatement st=cn.prepareStatement("select * from customer_subcategory where itemname like '"+name+"%'");
		ResultSet rs=st.executeQuery();
		if(!rs.isBeforeFirst())
		{
			out.print("<br><br><h1 style='text-align:center;color:#228b22;font-size:40px;'>No Record Found</h1>");
		}
		else
		{
			while(rs.next())
