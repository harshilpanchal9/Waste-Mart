...
<meta charset="UTF-8">
  ...
  function showCategory(qty,cartid,price,companyid)
  {
     /*  if (typeof XMLHttpRequest != "undefined")
      ...
      var url="company-ajax.jsp";
      url +="?qty="+qty+"&cartid="+cartid+"&price="+price+"&companyid="+companyid;
    ...
    <div class="about-inner" style="background-size:auto;">
        <div class="wrapper">
            ...
            <ul class="breadcrumbs-custom-path">
                ...
                <li><a href="company-homepage.jsp">Home <span class="fa fa-angle-right" aria-hidden="true"></span></a></li>
        ...
        <div class="wrapper">
            ...
            <div class="shopping-cart">
                ...
                <%
                	...
                	String qry="select * from company_cart where companyid=? and status=?";
                	...
                	while(rs.next())
                	{
                		int totalprice=Integer.parseInt(rs.getString(5))*10;
                	
                %>
                <form id="vinform<%=session.getAttribute("cartid") %>" action="CompanyRegistrationController" method="post">
                <div class="product">
                    ...
                    <div class="product-quantity">
                    	<input type="hidden" class="companyid" name="companyid" value="<%=session.getAttribute("companyid") %>" />
                        ...
                        <input type="number" class="itemqty"  name="qty" id="qty"  value="<%=rs.getString(6) %>" min="10" onchange="showCategory(this.value,<%=rs.getString(1)%>,<%=rs.getString(5) %>,<%=session.getAttribute("companyid") %>)">
                    </div>
                    ...
                    <div class="product-line-price">&#x20B9;<span id="atotal" name="cartids"><%=totalprice %></span></div>
                </div>
                </form>
                <%
                ...
                %>
                <form action="CompanyRegistrationController" method="post">
                <div class="totals">
                    ...
                    <div class="totals-item totals-item-total">
                      ...
                      <input type="hidden"  name="cid" value="<%=session.getAttribute("companyid") %>" />
