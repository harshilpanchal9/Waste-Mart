			...
			<div class="wrapper">
				<div class="form-content">
					<div class="form-left">
						...
						<div class="middle">
							<h4>Customer Forgot Password</h4>
						...
						<form action="CustomerRegistrationController" method="post" class="signin-form">	
							...
							<button class="btn" name="btn" style="background:#228B22; color:#ffffff;" value="verify" onclick="return submitValidation()">Update</button>
