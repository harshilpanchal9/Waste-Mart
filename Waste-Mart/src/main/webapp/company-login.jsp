...
<meta charset="UTF-8">
  ...
  <title>Home | Company-login</title>
  <link rel="stylesheet" href="assets/css/style-freedom.css">
  <link rel="icon" href="waste-mart.ico" type="iamge/x-icon">
  
   <script lang="javascript" text="text/javascipt">
		...
		<div class="wrapper">
			<div class="form-content">
				<div class="form-left">					
					...
					<form action="CompanyRegistrationController" method="post" onsubmit="return submitValidation()" class="signin-form">	
						...
						<button class="btn" name="btn" style="background:#228B22; color:#ffffff;" value="login">Login</button>
						<p style="text-align:center;margin-left:0px;"><a style="color:#228B22;" href="company-forgotpassword.jsp">Forgot Your Password?</a></p>
					</form>
				</div>					
			</div>
		</div>
